...
public class checknic extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txt_dmtBarcode = new javax.swing.JTextField();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txt_dmtBarcode, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(txt_dmtBarcode, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton3))
    ...
    private javax.swing.JTextField txt_dmtBarcode;
       ...
       DefaultTableModel dtm = (DefaultTableModel) tbl.getModel();
        ...
        try {
            ResultSet rs = model.db.getData("SELECT\n"
                    ...
                    + "uniquecustomerdetails.nic AND\n"
                    + "uniquecustomerdetails.nic = customer_register.nic AND\n"
                    + "customer_register.barcode = '" + txt_dmtBarcode.getText() + "'");
            while (rs.next()) {
                txtname.setText(rs.getString(1));
                int id = rs.getInt(3);
                String adno = rs.getString(2);
