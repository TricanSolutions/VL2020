        ...
        if (userstatus.LodUser.equals("pradeep")) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    String admisionno = rs.getString(3);
                    double amount = 0;
                    if (!rs.getString(5).equals("Stampfees")) {
