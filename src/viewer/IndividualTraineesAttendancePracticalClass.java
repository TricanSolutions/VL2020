...
public class IndividualTraineesAttendancePracticalClass extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cmbVClass = new javax.swing.JComboBox();
        cmbLessons = new javax.swing.JComboBox();
        ...
        cmbVNo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbVNoKeyPressed(evt);
            }
        });

        cmbVClass.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--SELECT--", "A", "B", "B1", "D", "D1" }));
        cmbVClass.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbVClassKeyPressed(evt);
            }
        });

        cmbLessons.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "--SELECT--", "Manual Stimulator(Indoor)", "Move Over and Stopping", "Clutch Balancing", "Shifting Gears", "Using Mirrors and Hand Signals", "Obsservation/Dicisions", "Positioning and Parking", "Reversing Straight", "Using Round About", "Reversing 90", "Driving in Traffic", "Turning to a by Road", "Entering to a main road", "Overtaking", "Reversing and Parking", "Using Junctions", "Starting and Move over(3 Wheeler)", "Positioning/Junctions(3 Wheeler)", "Reversing(3 Wheeler)", "Move Over and Stopping(M Cycle)", "Zig Zag and 8(M Cycle)", "Zig Zag and 8(M Cycle)" }));
        cmbLessons.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cmbLessonsKeyPressed(evt);
            }
        });

        jLabel10.setText("Lesson");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txt_barcode, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cmbLessons, javax.swing.GroupLayout.PREFERRED_SIZE, 426, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txt_instructor_name, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(cmbVNo, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(cmbVClass, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jCheckBox1)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txt_instructor_barcode, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cmbVClass, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(23, 23, 23)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cmbLessons, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel10))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void cmbVNoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbVNoKeyPressed
         if (evt.getKeyCode() == 10) {
            cmbVClass.grabFocus();
            

        }
    }//GEN-LAST:event_cmbVNoKeyPressed

    private void cmbVClassKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbVClassKeyPressed
         if (evt.getKeyCode() == 10) {
            cmbLessons.grabFocus();
            

        }
    }//GEN-LAST:event_cmbVClassKeyPressed

    private void cmbLessonsKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbLessonsKeyPressed
         if (evt.getKeyCode() == 10) {
            txt_admission_no.grabFocus();
            

        }
    }//GEN-LAST:event_cmbLessonsKeyPressed
    ...
    private javax.swing.JComboBox cmbLessons;
    private javax.swing.JComboBox cmbVClass;
...
//                    }
                  ...
                  //  for (int i = 0; i < tbl_practical.getRowCount(); i++) {
                        ...
                        String instructor;
                        String vclass;
                        String vehNo_vehClass;
//                   
                       // date = tbl_practical.getValueAt(i, 0).toString();
                        //topic = tbl_practical.getValueAt(i, 1).toString();
                        date = txt_date.getText();
                        topic = cmbLessons.getSelectedItem().toString();
                       ...
                       // vehicle = tbl_practical.getValueAt(i, 5).toString();
                        vehicle = cmbVNo.getSelectedItem().toString();
                        vclass = cmbVClass.getSelectedItem().toString();
                        vehNo_vehClass = vehicle +" ("+ vclass+")";
                      //  instructor = tbl_practical.getValueAt(i, 6).toString();
                        instructor = txt_instructor_name.getText();
//                   
                        model.db.putData("INSERT INTO practical_topics(date,name,starting_time,ending_time,duration_of_time,vehicle,instructor,status,attendance_practical_id)values"
                                + "('" + date + "','" + topic + "','" + starting_time + "','" + ending_time + "','" + duration + "','" + vehNo_vehClass + "','" + instructor + "','" + 1 + "','" + practical_topic_id + "')");
...
//                   
                        model.db.putData("INSERT INTO practical_topics(date,name,starting_time,ending_time,duration_of_time,vehicle,instructor,status,attendance_practical_id)values"
                                + "('" + date + "','" + topic + "','" + starting_time + "','" + ending_time + "','" + duration + "','" + vehNo_vehClass + "','" + instructor + "','" + 1 + "','" + maxid + "')");

                  //  }

                  com.Messages.normaljoption("Data saved for first time");
                } catch (Exception e) {
                    e.printStackTrace();
                }
...
//                txtnic.selectAll();
    ...
    private void loadVno() {
        //
        try {
            cmbVNo.addItem("-SELECT-");
            ResultSet rs = model.db.getData("SELECT\n"
                    + "instructor.vehicle_name\n"
                    + "FROM\n"
                    + "instructor");
