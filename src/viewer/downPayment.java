...
public class downPayment extends javax.swing.JFrame {
    ...
    private void changetblPro() {
        ...
        tbl.getColumnModel().getColumn(0).setCellRenderer(cellRenderer);
    ...
    private void initComponents() {
        ...
        txtadmissionno.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtadmissionno.setForeground(new java.awt.Color(0, 0, 204));
        ...
        txtpay.setForeground(new java.awt.Color(0, 0, 204));
        ...
        cmbreason.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        cmbreason.setForeground(new java.awt.Color(204, 0, 204));
        ...
        cmbpaymentcategory.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        cmbpaymentcategory.setForeground(new java.awt.Color(204, 0, 204));
        ...
        txtclasses.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtclasses.setForeground(new java.awt.Color(0, 0, 204));

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 153, 51));
        jLabel6.setText("Reason for Pay");

        lblUpdatefullamount.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblUpdatefullamount.setForeground(new java.awt.Color(0, 153, 51));
        lblUpdatefullamount.setText("Update Full Amount");

        txtUpdateFullAmount.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtUpdateFullAmount.setForeground(new java.awt.Color(0, 0, 204));
        ...
        txtintroduceradmissionno.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtintroduceradmissionno.setForeground(new java.awt.Color(0, 0, 204));
        ...
        txtintroducerdiscount.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtintroducerdiscount.setForeground(new java.awt.Color(0, 0, 204));
        txtintroducerdiscount.setText("0");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE, 307, Short.MAX_VALUE)
                .addGap(18, 18, 18)
        ...
        cmbreasonsecond.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        cmbreasonsecond.setForeground(new java.awt.Color(204, 0, 204));
        ...
        txttotsecond.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txttotsecond.setForeground(new java.awt.Color(0, 0, 204));

        jLabel14.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(0, 153, 51));
        jLabel14.setText("Payment Category");

        cmbpaymentcatsecond.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        cmbpaymentcatsecond.setForeground(new java.awt.Color(204, 0, 204));
        ...
        txtbalance.setBackground(new java.awt.Color(255, 255, 51));
        ...
        txtpaysecond.setBackground(new java.awt.Color(255, 255, 153));
        txtpaysecond.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtpaysecond.setForeground(new java.awt.Color(255, 0, 0));
        ...
        txtdiscount.setForeground(new java.awt.Color(0, 0, 204));
...
//           
    ...
    private void sendsms() {
        ...
        try {
            ...
            String message = "&message=" + "Thank You for Joining with Vijaya Learners... vijayalearners.com. More info 0372223969";
